...
for i in range(0, len(data)):
    ...
    for i in audioFileNames:
        ...
        totalVideolength += audioFileLength
        AudioFileLengthsList.append(audioFileLength)
    print("script: ",script)
    print("AudioFileLengthsList: ",AudioFileLengthsList)
    print("AudioFileLengthsList: ",audioFileLength)

    StartEndTImes = VoiceRecognitition1.ScriptSplitterV2_times(script , AudioFileLengthsList)
    ...
    VideoGenerator1.generateBackgroundFootage(totalVideolength, 'ValoClips//', videoFilePath + "background.mp4")
    ...
    VideoGenerator1.overlay_audio_video(videoFilePath + "backgroundCroped.mp4", audioFilePath + SubRedditName + ".wav", videoFilePath + "CropedAudio.mp4", totalVideolength)
    print("Start End times", StartEndTImes)
